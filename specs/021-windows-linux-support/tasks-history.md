# Historical Tasks: Windows and Linux Desktop Support (T001-T067)

> Prior implementation history through 2026-08-26, including the archived BUG-001 through BUG-004 remediation cycles. Constitution v7.0.0 and the 2026-08-27 plan supersede this entire task list; checked items are evidence, and any unchecked legacy validation item is canceled rather than active. Nothing here may be resumed or treated as the active implementation queue.
