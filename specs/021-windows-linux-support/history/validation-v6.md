# Historical Validation Record: Windows and Linux Desktop Support (Constitution v6)

> Historical snapshot through 2026-08-26. Its BUG-001 through BUG-004, DMG, checksum-sidecar, joined-release, GHCR, and rollback evidence is superseded by constitution v7.0.0 and the 2026-08-27 plan. Preserve it for audit history only; do not use it to assess the active delta.
